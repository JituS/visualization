window.onload = function() {
	var popupateCountryName = function(){
	...
	var outerWidth = 900;
	var outerHeight = 600;
	var margin = {top: 30, down: 50, right: 30, left: 100};
	...
	var render = function(data) {
		...
		var maxPopulation = d3.max(data, function(each){return each[yColumn]});
		var minPopulation = d3.min(data, function(each){return each[yColumn]});
